...
public class MediaValidationException extends RuntimeException implements LocalizedException {

    private final String messageKey;
    private final Object[] messageArgs;
    private final Map<String, String> fieldErrors;

    public MediaValidationException(String messageKey, Map<String, String> fieldErrors, Object... messageArgs) {
        super(messageKey);
